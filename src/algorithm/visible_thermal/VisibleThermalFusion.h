...
#include "algorithm/visible_thermal/VisibleThermalFusionTypes.h"

#include <unordered_map>

namespace tri::algorithm {

class VisibleThermalFusion final : public FusionAlgorithm {
public:
    FusionMode mode() const noexcept override { return FusionMode::VisibleThermal; }
    const char* name() const noexcept override { return "VisibleThermalFusion"; }
...
private:
    ...
    visible_thermal::VisibleThermalFusionParams params_{};
