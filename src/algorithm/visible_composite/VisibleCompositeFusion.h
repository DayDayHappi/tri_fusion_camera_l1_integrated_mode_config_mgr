...
#include "algorithm/visible_composite/VisibleCompositeFusionTypes.h"

#include <unordered_map>

namespace tri::algorithm {

class VisibleCompositeFusion final : public FusionAlgorithm {
public:
    FusionMode mode() const noexcept override { return FusionMode::VisibleComposite; }
    const char* name() const noexcept override { return "VisibleCompositeFusion"; }
...
private:
    ...
    visible_composite::VisibleCompositeFusionParams params_{};
