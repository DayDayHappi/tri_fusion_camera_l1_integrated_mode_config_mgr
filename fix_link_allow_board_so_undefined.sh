...
BACKUP="${FILE}.bak_allow_shlib_undefined_${TS}"
...
echo
echo "[CHECK] linker flags:"
grep -n "allow-shlib-undefined\|rpath-link\|CMAKE_EXE_LINKER_FLAGS" "$FILE"

echo
echo "[DONE] toolchain patched."
